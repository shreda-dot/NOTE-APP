  ...
  return (
    <form className="mt-10 flex flex-col gap-6" onSubmit={handlesubmit}>
      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <div className="form-group w-full">
          <label htmlFor="tags" className="mb-2 block text-sm font-bold text-gray-700">
            TAGS
          </label>
          <CreatableSelect
            id="tags"
      ...
      <div className="flex justify-end gap-2">
         <button type="submit" className="bg-blue-600 cursor-pointer text-white px-4 py-2 rounded hover:bg-blue-700 transition">
            Save Note
         </button>
         <Link to="..">
         <button type="button" className="border cursor-pointer border-gray-300 px-4 py-2 rounded hover:bg-gray-50">
            Cancel
         </button>
         </Link>
      </div>
